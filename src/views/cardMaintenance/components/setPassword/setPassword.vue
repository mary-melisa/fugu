<template>
  <el-dialog class="commonDialog" title="重置密码" :visible.sync="visible" :close-on-click-modal="false" width="400px"
    v-loading="loading" element-loading-text="拼命上传中" element-loading-spinner="el-icon-loading"
    element-loading-background="rgba(0, 0, 0, 0.8)" :before-close="cancelModule">
    <el-form ref="addMeal" :model="addMeal" :rules="rules" class="commonForm mt45" label-width="35%">
      <el-form-item label="姓名:">
        <el-input class="commonInput" v-model="username" disabled maxlength="50"></el-input>
      </el-form-item>
