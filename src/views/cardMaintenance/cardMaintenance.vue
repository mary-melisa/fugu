...
<template>
  <div class="cardMaintenance">
    ...
    <div class="search">
      <div class="fieldItem">
        ...
        <el-select class="commonSelect ml15" v-model="conditionForm.categoryId" placeholder="请选择">
          ...
          <el-option v-for="item in optionsList" :key="item.id" :label="item.categoryName" :value="item.id">
          </el-option>
        </el-select>
      </div>
      <div class="fieldItem">
        <span>姓名：</span>
        <el-input placeholder="请输入姓名" class="commonInput" v-model="conditionForm.userName" style="width: 200px;"
          maxlength="50"> </el-input>
      </div>
      <div class="fieldItem">
        <span>卡号：</span>
        <el-input placeholder="请输入卡号" class="commonInput" v-model="conditionForm.cardNumber" style="width: 200px;"
          maxlength="24">
        </el-input>
      </div>
    ...
    <SetPassword v-if="passwordDialog" v-on:cancelModule="cancelModule" v-on:getTableData="getTableData"
      :currentMeal="currentMeal" v-on:setPassword="setPassword"></SetPassword>
  </div>
</template>
