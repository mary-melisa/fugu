...
<script>
export default {
    props:['parentTableData', 'parentDefault', 'setCurrentMeal', 'setParentSelection','parentEdit','parentDel','parentHandleSizeChange','parentHandleCurrentChange', 'parentOptionsList', 'nameList'],
    data() {
        return {
            currentPage: 1,
            multipleSelection: [],
