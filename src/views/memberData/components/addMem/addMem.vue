<template>
 <el-dialog
  class="commonDialog"
  :title="parentTitle === 1 ? '添加会员信息' : '编辑会员信息'"
  ...
  :before-close="cancelModule">
        <el-form ref="addMeal" :rules="rules" class="commonForm mt45" :model="addMeal" label-width="35%" @submit.native.prevent>
            ...
            <el-form-item v-if="usertype == 1"  label="班级:" :required="usertype == 1 ? true : false">
                <el-input class="commonInput" v-model.trim="className" ></el-input>
            </el-form-item>
            ...
            <el-form-item  label="工号:" :required="usertype == 1 ? true : false" v-if="parentTitle === 1">
                <el-input type="number" class="commonInput" :placeholder="usertype === 1 ? '可输入学生编号、学籍号' : ''" v-model="employeeID" ></el-input>
            </el-form-item>
             ...
             <el-form-item label="联系电话:" :required="usertype == 1 ? false : true">
                <el-input class="commonInput" v-model="mobile" ></el-input>
            </el-form-item>
            <el-form-item v-if="this.usertype==1 && parentTitle === 1" label="卡号:" >
                <el-input class="commonInput" v-model="cardNumber" ></el-input>
            </el-form-item>
